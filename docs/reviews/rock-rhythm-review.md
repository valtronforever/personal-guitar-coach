...
- Full Core/App suite and signed local Release evidence are pending below. Real playing comfort, actual sound/latency and native accessibility remain pending_user.
