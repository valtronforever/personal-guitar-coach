...
- The final input drain includes reported input hardware latency in addition to the 1.4-second residual/detector allowance, so known slow input paths do not lose the last marker.
