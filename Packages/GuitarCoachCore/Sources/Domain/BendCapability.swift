...
public enum BendCapability {
    ...
    public static func supports(bend: PitchBend, durationTicks: Int64, bpm: Double, frequency: Double, pulseTicks: Int64 = MusicalTime.ppq) -> Bool {
        ...
        let points = bend.points(durationTicks: durationTicks), secondsPerTick = 60 / bpm / Double(pulseTicks)
