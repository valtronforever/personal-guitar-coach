...
public struct FretRegion: Codable, Equatable, Hashable, Sendable {
    ...
    public init(firstFret: Int, windowFrets: Int) throws {
        guard (0...24).contains(firstFret), (1...13).contains(windowFrets) else { throw PositioningError.invalidPolicy }
...
public struct PositioningPolicy: Codable, Equatable, Sendable {
    ...
    public func validate() throws {
        ...
        guard preserve == "soundingPitch", let windowFrets, (1...13).contains(windowFrets), let allowedStarts, allowOriginal != nil else { throw PositioningError.invalidPolicy }
