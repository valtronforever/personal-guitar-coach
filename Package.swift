...
let package = Package(
    ...
    products: [.executable(name: "PersonalGuitarCoach", targets: ["PersonalGuitarCoach"]),
               .executable(name: "CoachAgentService", targets: ["CoachAgentService"])],
    dependencies: [.package(path: "Packages/GuitarCoachCore"), .package(url: "https://github.com/jpsim/Yams.git", exact: "6.2.2")],
    targets: [
        .executableTarget(name: "AgentServiceProbe", dependencies: [.product(name: "AgentBridge", package: "GuitarCoachCore")], path: "Tests/AgentServiceProbe"),
        .executableTarget(name: "CoachAgentService", dependencies: [.product(name: "AgentBridge", package: "GuitarCoachCore")], path: "AgentService", exclude: ["Info.plist"]),
        .executableTarget(
            name: "PersonalGuitarCoach",
            dependencies: [
                .product(name: "Domain", package: "GuitarCoachCore"),
                .product(name: "AgentBridge", package: "GuitarCoachCore"),
