...
- Scale/position module continuation: topics 57–64 authored with five new lessons and substantive expansions of the three baseline studies. Full major/natural-minor and both pentatonic families, blues passing tones, neighboring-position routes, exact-pitch relocation and quarter-note sequences now have distinct practice plus quizzes/self-observation. Inventory: 67 bundles/61 visible, 60 authored topics, 1 needing review, 67 todo. See [same-agent review](../../docs/reviews/scale-position-course-review.md); verification/Release/CI evidence is being finalized. Full curriculum and native/hardware acceptance remain open.
