...
Logs: `/tmp/rapid-{core-regression,contracts-final,app-verified,content-final,author-tests,ui,release,bundle,xpc}.log`. Delivery: [PR98](https://github.com/valtronforever/personal-guitar-coach/pull/98), head `ce51880a72d8bd982b6903a68afaaa012d7cdbb9`, [exact-head CI35207416758](https://github.com/valtronforever/personal-guitar-coach/actions/runs/35207416758). Merge requires that run to pass; after merge only the explicitly deferred native/physical checks remain.
