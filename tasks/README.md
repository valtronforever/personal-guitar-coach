...
- `in_progress` — [Full curriculum and library UX](follow-up/full-curriculum.md): all 128 agreed lessons, required functional extensions, course organization and discovery. Modules 1–3 authored and first minor/major chord lessons added; strum-reference, harmonic-root, low-register, opt-in sustain and accent-reference extensions implemented, remaining course and hardware validation pending.
