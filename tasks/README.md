...
- `in_progress` — [Full curriculum and library UX](follow-up/full-curriculum.md): all 128 agreed lessons, required functional extensions, course organization and discovery. Modules 1–6 and introductory picking/synchronization authored; strum-reference, harmonic-root, low-register, opt-in sustain and accent-reference extensions implemented, open-bass transposition anchor, palm-muting reference cues and timed bend/return pitch assessment added; scale/position module 57–64 and triplet/shuffle topics 65–66 authored; remaining course and hardware validation pending.
