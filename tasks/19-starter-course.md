...
C Standard follow-up: see [scope and evidence](follow-up/c-standard-course.md). Six separately identified en/uk lessons retain the same fingerings/timing with sounding A♭ major, F minor pentatonic and Cm. The original six remain unchanged; task 19 retains `pending_user` for beginner/live-guitar acceptance.
