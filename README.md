...
Settings → Instrument offers eight paired presets: **E Standard / Drop D, D Standard / Drop C, C Standard / Drop B♭, B Standard / Drop A**, plus custom tuning. Each Drop lowers only string 6 by a whole tone. Notes below C2 remain outside the current practice-scoring capability; lesson display and tuning selection remain available. See the [preset table](tasks/follow-up/standard-drop-presets.md).
